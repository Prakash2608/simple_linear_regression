...
from simple_regression.utils.main_utils import save_object, evaluate_models
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # print("train_arr shape: ", len(train_array[0]))
            # print("test_arr shape: ", len(test_array[0]))
            ...
            if best_model_score<0.6:
                raise AppException("No best model found.")
